...
public class UtestSignUpAddresPage {
   ...
   // public static final Target USER_CITY = Target.the("Ciudad del usuario").locatedBy("//*[text()='Medellín']");
    ...
    //public static final Target BTN_USER_COUNTRY = Target.the("ZIP code del usuario").locatedBy("//*[text()='Colombia']");

   // public static final Target BTN_SELECT_COUNTRY = Target.the("ZIP code del usuario").locatedBy("//*[text()='Colombia']");
