...
public class UtestSignUpAddresPage {
    ...
    public static final Target USER_COUNTRY = Target.the("ZIP code del usuario").locatedBy("id:zip");

    public static final Target BTN_NEXTDEVICES = Target.the("boton next devices").locatedBy("id:zip");
