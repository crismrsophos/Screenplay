...
Feature: Automatización de Patch
  ...
  Scenario Outline: Actualizar Información Usuario Con Token - Patch en Booking
    ...
    When ejecuta el método patch "<endpoint>" con los siguientes datos
    ...
    Examples:
      ...
      | https://restful-booker.herokuapp.com/ | booking/2 | Erling    | Haaland  | 2500       | true        | 2021-07-02 | 2021-10-02 | me duele el estomago |