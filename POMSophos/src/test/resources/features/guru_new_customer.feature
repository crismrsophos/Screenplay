...
Feature: Demo POM
  ...
  Scenario: Agregar cliente en Guru
    ...
    When Agrego un cliente en la pagina con los datos "Alejandro Araque Marin", "03/05/1995", "Diagonal 56 45 67", "Bello", "Antioquia", "123458", "3042467297", "alexanreraque@gmail.com" y "Messiel10"
